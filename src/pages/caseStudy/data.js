  ...
  features: [
    {
      ...
      properties: {
        ...
        impact:
          "The disaster exacerbated existing gender inequalities, as women faced significant barriers in accessing relief and recovery resources, impacting their livelihoods and overall well-being.",
        gender_data:
    ...
    },
    {
      ...
      properties: {
        ...
        impact:
          "Women, especially in rural areas, faced <b>disproportionately higher risks</b> during and after the cyclone.",
        gender_data:
    ...
    },
    {
      ...
      properties: {
        ...
        impact:
          "Nigeria is getting hotter and drier. These climate disasters <b>disrupt access to schools and disproportionately affect girls, who often face barriers to attendance</b>.",
        gender_data:
    ...
    },
    {
      ...
      properties: {
        ...
        impact:
          "<b>Typhoon Haiyan increased gender inequality in the Philippines by raising women's mortality rates and limiting their access to relief and education.</b>",
        gender_data:
